...
class StorageScopesHooks {
    ...
    // #appendAccessCheckQuery
    static String getWhereClause(LocalCallingIdentity callingIdentity, boolean forWrite) {
        StorageScope[] scopes = callingIdentity.getStorageScopes();
        if (scopes == null) {
            return null;
        }
        ...
        String fragment = getWhereClauseInner(scopes, callingIdentity, forWrite);
    ...
    private static String getWhereClauseInner(StorageScope[] scopes, LocalCallingIdentity callingIdentity, boolean forWrite) {
